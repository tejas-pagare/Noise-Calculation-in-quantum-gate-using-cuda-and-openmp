...
#include "../src/gpu/gpu_subroutines.hpp"
#if COMPILE_CUDA
    #include "../src/gpu/gpu_types.cuh"

    #include "../src/gpu/gpu_kernels.cuh"

    #include "../src/gpu/gpu_thrust.cuh"

#endif

#if COMPILE_CUQUANTUM
    #include "../src/gpu/gpu_cuquantum.cuh"
